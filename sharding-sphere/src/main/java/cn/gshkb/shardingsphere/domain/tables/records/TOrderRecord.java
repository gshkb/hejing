...
public class TOrderRecord extends UpdatableRecordImpl<TOrderRecord> implements Record7<Long, String, Long, Timestamp, Timestamp, Long, Boolean> {

    private static final long serialVersionUID = 46421079;
     ...
     */
    public TOrderRecord setVersion(Long value) {
        set(5, value);
        return this;
    }
     ...
     */
    @Override
    public Row7<Long, String, Long, Timestamp, Timestamp, Long, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row7<Long, String, Long, Timestamp, Timestamp, Long, Boolean> valuesRow() {
     ...
     */
    @Override
    public TOrderRecord value6(Long value) {
        setVersion(value);
        return this;
    }
     ...
     */
    @Override
    public TOrderRecord values(Long value1, String value2, Long value3, Timestamp value4, Timestamp value5, Long value6, Boolean value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TOrderRecord(Long id, String name, Long userId, Timestamp createAt, Timestamp updateAt, Long version, Boolean delFlag) {
        super(TOrder.T_ORDER);
